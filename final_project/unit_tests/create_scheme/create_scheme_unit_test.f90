...
! TITLE            : EZ_PARALLEL
! PROJECT          : GENESIS
! MODULE           : CREATE_SCHEME UNIT TEST
...
!> Jason Turner
! DESCRIPTION:
!> @brief The unit test for the <tt>CREATE_SCHEME</tt> subroutine.
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

PROGRAM CREATE_SCHEME_UNIT_TEST
...
END PROGRAM CREATE_SCHEME_UNIT_TEST
