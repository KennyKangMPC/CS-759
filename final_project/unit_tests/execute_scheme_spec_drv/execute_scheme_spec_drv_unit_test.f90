...
! TITLE            : EZ_PARALLEL
! PROJECT          : GENESIS
! MODULE           : EXECUTE_SCHEME_SPEC_DRV UNIT TEST
...
!> Jason Turner
! DESCRIPTION:
!> @brief The unit test for the <tt>EXECUTE_SCHEME_SPEC_DRV</tt> subroutine.
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

PROGRAM EXECUTE_SCHEME_SPEC_DRV_UNIT_TEST
  ...
  CALL EXECUTE_SCHEME_SPEC_DRV(arr, SPEC_DRV_1D_2, 1, sch)
...
END PROGRAM EXECUTE_SCHEME_SPEC_DRV_UNIT_TEST
