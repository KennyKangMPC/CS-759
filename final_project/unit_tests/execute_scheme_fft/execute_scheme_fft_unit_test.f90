...
! TITLE            : EZ_PARALLEL
! PROJECT          : GENESIS
! MODULE           : EXECUTE_SCHEME_FFT UNIT TEST
...
!> Jason Turner
! DESCRIPTION:
!> @brief The unit test for the <tt>EXECUTE_SCHEME_FFT</tt> subroutine.
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

PROGRAM EXECUTE_SCHEME_FFT_UNIT_TEST
  ...
  CALL EXECUTE_SCHEME_FFT(arr, FFT_1D_1, sch)
...
END PROGRAM EXECUTE_SCHEME_FFT_UNIT_TEST
