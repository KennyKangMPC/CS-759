...
!> Jason Turner
! DESCRIPTION:
!> @brief The unit test for the <tt>MAX_VAL</tt> subroutine.
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

PROGRAM MAX_VAL_UNIT_TEST
  ...
  DO i = 0, sch%commSize-1
     IF (i .EQ. sch%procID) THEN
        PRINT *, " "
        PRINT *, "procID: ", sch%procID, " maxValue: ", maxValue
     END IF
     CALL MPI_BARRIER(sch%comm, ierror)
  END DO
