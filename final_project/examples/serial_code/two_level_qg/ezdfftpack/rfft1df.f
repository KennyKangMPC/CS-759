...
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      SUBROUTINE RFFT1DF(dim1, matrix)
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!     SW real forward 1D FFT (FFFT) initialization, fills WSAVE.
      WSAVE = 0.
      CALL DFFTI(dim1, WSAVE)

!     Perform 1D FFFT on matrix.
      CALL DFFTF(dim1, matrix(:), WSAVE) ! SW FFFT routine.

      END SUBROUTINE RFFT1DF
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
